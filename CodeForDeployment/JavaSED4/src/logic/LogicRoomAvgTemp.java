...
public class  LogicRoomAvgTemp extends RoomAvgTemp  { 
   ...
   public LogicRoomAvgTemp(PubSubMiddleware pubSubM, Device deviceInfo, Object ui,Context myContext) {
	    	    ...
	    	    //TODO : write code here.
	    	    	 synchronized (this.temps) {
	    	             ...
	    	             if (numSample == NUM_SAMPLE_FOR_AVG) {
	    	                 ...
	    	                 System.out.println("The current Average Temperature" +  currentAverage);
